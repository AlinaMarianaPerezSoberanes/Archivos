...
{
  "$end", "error", "$undefined", "INT", "DESPLIEGA", "IF", "ELSE", "'('",
  "')'", "$accept", "program", "sent", "exp", YY_NULLPTR
};
#endif
...
{
      13,     5,    15,     1,     2,     6,     7,     8,    11,    12,
       0,    14,     0,    10
};

static const yytype_int8 yycheck[] =
{
      12,     7,    14,     4,     5,     7,     0,     3,     8,     8,
      -1,     6,    -1,     6
};
