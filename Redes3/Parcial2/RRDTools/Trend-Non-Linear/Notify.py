...
COMMASPACE = ', '
# Define params
rrdpath = '/home/escom/PycharmProjects/Trend-Non-Linear/RRD/'
pngpath = '/home/escom/PycharmProjects/Trend-Non-Linear/IMG/'
fname = 'netP.rrd'
width = '500'
height = '200'
...
def check_aberration(rrdpath, fname):
    ...
    #Grafica para obtener los valores de failures
    ...
    if (fmin != fmax):
        if (flast == 1):
            ab_status = 1 # comportamiento empezo
        else:
            ab_status = 2 # el comportamiento finalizo
        #en cero no hay cambios
    return ab_status
